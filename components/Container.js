...
export default function Container(props) {
  ...
  const meta = {
    title: 'Pranav Kumar Pulusu – ML Engineer, Developer, Aspiring Researcher.',
    description: `My Portfolio developed with Next.js`,
    image: 'https://kumaarpranv.github.io/static/images/banner.png',
    type: 'website',
    ...customMeta
  };
  ...
  return (
    <div className="bg-white dark:bg-black">
      <Head>
        ...
        <meta property="og:url" content={`https://kumaarpranv.github.io${router.asPath}`} />
        <link rel="canonical" href={`https://kumaarpranv.github.io${router.asPath}`} />
        <meta property="og:type" content={meta.type} />
        <meta property="og:site_name" content="Pranav kumar" />
        <meta property="og:description" content={meta.description} />
        <meta property="og:title" content={meta.title} />
        <meta property="og:image" content={meta.image} />
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:site" content="@amateurtheorist" />
